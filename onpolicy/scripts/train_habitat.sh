...
num_agents=2
algo="mappo"
exp="(seed1)16_(tans)_pos_attn_goal_time(0.97)_overlap_comp_penalty"
seed_max=1
...
do
    ...
    --num_local_steps 15 --max_episode_length 300 --num_env_steps 4500000 --ppo_epoch 4 --gain 0.01 \
    --lr 2.5e-5 --critic_lr 2.5e-5 --use_maxpool2d \
    --cnn_layers_params '32,3,1,1 64,3,1,1 128,3,1,1 64,3,1,1 32,3,2,1' --hidden_size 256 --log_interval 1 \
    ...
    --wandb_name "mapping" --user_name "yang-xy20" \
    ...
    --agent_invariant --invariant_type alter_attn --use_pos_embedding --use_id_embedding \
    --multi_layer_cross_attn --add_grid_pos --use_self_attn --use_intra_attn
