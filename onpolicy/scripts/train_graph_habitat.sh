...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=6,4,7 python train/train_graph_habitat.py --scenario_name ${scenario} \
    ...
    --use_double_matching --matching_type multi --global_downscaling 3 --map_size_cm 3600 --use_async
