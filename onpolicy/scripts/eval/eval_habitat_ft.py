...
def parse_args(args, parser):
    ...
    parser.add_argument("--ghost_node_size", default=24, type=int)
    ...
    parser.add_argument("--dis_gap", default=3, type=int)
    parser.add_argument("--max_frontier", default=100, type=int)
    ...
    parser.add_argument('--use_selected_overall_scenes', default=False, action='store_true')
    ...
    parser.add_argument('--use_distance', default=True, action='store_false')
    parser.add_argument('--use_edge_info', default=None, choices=['learned', 'hard'])
    parser.add_argument('--use_agent_node', default=None, choices=['learned', 'hard'])
...
def main(args):
    ...
    if all_args.algorithm_name == "rmappo" or all_args.algorithm_name == "rmappg":
        ...
        assert (all_args.algorithm_name[3:] in ['apf', 'utility', 'rrt', 'nearest','voronoi','wma_rrt','ILP'])
    else:
        raise NotImplementedError
