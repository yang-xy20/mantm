...
num_agents=3
algo="ft_rrt" # ft_rrt ft_utility ft_apf  
exp="3-2agents_rrt_eval21_auc"
seed_max=1
...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=7 python eval/eval_habitat_ft_auc.py --scenario_name ${scenario} \
    --env_name ${env} --algorithm_name ${algo} --experiment_name ${exp} --num_agents ${num_agents} \
    --split "train" --use_same_scene --scene_id 21 --eval_episodes 100 --use_eval --ifi 0.01 --seed 3 \
    --n_training_threads 1 --n_rollout_threads 1 --num_mini_batch 5 --max_episode_length 300 \
    ...
    --use_max --use_max_map --use_different_start_pos --use_fixed_start_pos --change_agents \
    --secode_stage_agents 2
